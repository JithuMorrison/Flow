...
getCodeStream(indexStream, colors) {
  ...
  structureGif() {
    ...
    // Fix: properly calculate packed field using bit operations
    // Bits 0: transparent flag, Bit 1: user input (0), Bits 2-4: disposal, Bits 5-7: reserved
    const graphicsControlPackedField = (disposal << 2) | transparentFlag;
